...
function Content() {
    return (
        ...
        <div className="px-4 py-6 md:py-16 prose md:prose-xl hover:prose-headings:underline underline-offset-4 hover:prose-a:text-iff-orange responsive-container">
            ...
            <h1>2 steps to protect Net Neutrality:</h1>
            <h2>Step 1: Write to TRAI</h2>
            <p>
            ...
            <h2>Step 2: Register for the OHD</h2>

            <p>
                Our mission doesn’t end here. TRAI is organising a virtual Open House Discussion (OHD) on the consultation paper on September 19, 2023. Register for the OHD today and make sure your voice is heard. This will potentially be the last chance under this consultation process for us internet freedom fighters to save the internet.
            </p>
            <div className="text-center">
                <button
                    ...
                    onClick={() => {
                        window.open('https://www.airmeet.com/e/23e95f10-4c9c-11ee-9132-bb6a19360c2e', '_blank');
                    }}
                >
                    Register for the OHD by TRAI
                </button>
            </div>
